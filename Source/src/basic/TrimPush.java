 ...
 * graphically as:
 * <p>
 * <img src="{@docRoot}/doc-files/basic/TrimPush.png" alt="Processor graph">
 * @see PipingBinary
 * @author Sylvain Hallé
 * @difficulty Easy
 */
public class TrimPush
{
	public static void main (String[] args)
	{
		...
		/* Connect the trim processor to a Print processor. */
		Print print = new Print();
		Connector.connect(trim, print);
		
		/* Let us now print what we receive by pushing events into trim. */
