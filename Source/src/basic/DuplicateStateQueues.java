 ...
 * @difficulty Easy
 */
public class DuplicateStateQueues 
{
  public static void main(String[] args)
  {
    ...
    //* Let us now duplicate sum1 and push events to the copy. The use of
    // true in the call to duplicate indicates that we preserve the original's
    // complete state.
